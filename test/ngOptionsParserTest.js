describe("ngOptionsParser", function() {
    it("should test basic patterns for ngOptionsParser", function() {
        expect(optionsProxy.ngOptionsParser("obj.name for obj in objects")).toEqual({
            attributeName: 'name',
            values: 'objects',
    ...
    it("is a pattern test with filter", function() {
        expect(optionsProxy.ngOptionsParser("obj.name for obj in objects | filter: {type: 'object'}")).toEqual({
            attributeName: 'name',
            values: 'objects',
    ...
    it("is an pattern test (3)", function() {
        expect(optionsProxy.ngOptionsParser("t as t.name for t in types | filter: {type: 'object'}")).toEqual({
            attributeName: 'name',
            values: 'types',
    ...
    it("is an pattern test (4)", function() {
        expect(optionsProxy.ngOptionsParser("t as t.name group by (t.subtype + ' ' + t.type) for t in types")).toEqual({
            attributeName: 'name',
            values: 'types',
